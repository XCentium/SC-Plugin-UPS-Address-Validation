...
namespace Sitecore.Commerce.Plugin.UpsAddressValidation
{
    ...
    public class ConfigureServiceApiBlock : PipelineBlock<ODataConventionModelBuilder, ODataConventionModelBuilder, CommercePipelineExecutionContext>
    {
        ...
        public override Task<ODataConventionModelBuilder> Run(ODataConventionModelBuilder modelBuilder, CommercePipelineExecutionContext context)
        {
            ...
            configuration.Parameter<string>("AddressLine1");
            configuration.Parameter<string>("AddressLine2");
            configuration.Parameter<string>("BuildingName");
            configuration.Parameter<string>("ConsigneeName");
            configuration.Parameter<string>("City");
            configuration.Parameter<string>("State");
            configuration.Parameter<string>("ZipCode");
            configuration.Parameter<string>("CountryCode");
